    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-teal-50 to-yellow-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {lessons.map((lesson) => {
            const isAvailable = lesson.id <= 6; // All six lessons are now available!
            const Component = isAvailable ? Link : 'div';
            
            return (
              <Component
                key={lesson.id}
                to={isAvailable ? lesson.path : undefined}
        ...
        <div className="mt-16 text-center bg-white rounded-2xl shadow-lg p-12">
          ...
          <p className="text-gray-600 max-w-xl mx-auto">
            We're working on more interactive coding lessons. Stay tuned for updates on loops, conditional logic, and advanced programming concepts!
          </p>
        </div>
      </div>
...
const lessons = [
  ...
  },
  {
    ...
    iconBg: "bg-[#fec601]/10",
    path: "/lessons/conditional-logic"
  },
  {
    id: 5,
    title: "Debugging",
